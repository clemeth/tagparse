...
> Bjerkeland, D. C. 2022. Tagging and Parsing Old Texts with New Techniques. University of Oslo. URL: <https://www.duo.uio.no/bitstream/handle/10852/96445/thesis.pdf>.
...
2. Edit [`config.py`](config.py) to your needs. The following parameters are available:
   ...
   `expand_rough` | `bool` | `True` to add a _heta_ to words with rough breathing. `False` to do nothing.
